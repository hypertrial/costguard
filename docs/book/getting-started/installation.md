...
```bash
curl -fsSL https://raw.githubusercontent.com/hypertrial/costguard/main/scripts/install.sh | sh -s -- v2.2.0
```
...
```bash
cargo install --git https://github.com/hypertrial/costguard --tag v2.2.0 costguard-cli
```
