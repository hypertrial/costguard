...
| Release qualification | Exact-SHA [`ci.yml`](../../../.github/workflows/ci.yml) push evidence plus an independently dispatched [`benchmark.yml`](../../../.github/workflows/benchmark.yml) run | `verify_ci_history.py` requires the named successful jobs from both workflows before the signed tag release proceeds |
